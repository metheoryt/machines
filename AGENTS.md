...
- **server / g513ie** — ASUS ROG **G15**, RTX 3050 Ti, Windows 11 + Docker Desktop, hostname `g513ie` (SSH alias `server`); the always-on cyphy.kz homeserver — runs the cyphy.kz service platform
