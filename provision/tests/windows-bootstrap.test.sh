...
#
# hosts/desktop/windows/install.ps1 is the `irm ... | iex` one-liner a freshly
...
# g16 -> desktop rename 2026-07-20, restore.ps1's deletion 2026-07-31), and threw
...
boot="$repo/hosts/desktop/windows/install.ps1"
...
rb="$repo/hosts/desktop/windows/windows-reinstall-runbook.md"
