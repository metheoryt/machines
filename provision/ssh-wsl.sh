...
# so every /ship and memory-harvest run from that box had been silently skipping
...
# and memory-harvest's fleet-gather — down with it. Omitting a line to mean "the
